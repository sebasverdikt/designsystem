        ...
        var t = {
                362: (t, e, i) => {
                    ...
                    async function d(t, e) {
                        var i;
                        void 0 === e && (e = {});
                        const { x: o, y: n, platform: r, rects: s, elements: a, strategy: d } = t,
                            ...
                            b = c(
                                r.convertOffsetParentRelativeRectToViewportRelativeRect
                                    ? await r.convertOffsetParentRelativeRectToViewportRelativeRect({
                                          rect: "floating" === p ? { ...s.floating, x: o, y: n } : s.reference,
                    ...
                    function v(t, e, i) {
                        ...
                        const o = n(t),
                            a = r(t),
                            l = s(a);
                        let c = "x" === a ? (o === (i ? "end" : "start") ? "right" : "left") : "start" === o ? "bottom" : "top";
                                ...
                                void 0 === t && (t = {}),
                                {
                                    ...
                                    async fn(e) {
                                        ...
                                        const { x: c, y: u, rects: f, middlewareData: p, placement: h, platform: g, elements: m } = e,
                                            ...
                                            _ = (function (t, e, i) {
                                                return (t ? [...i.filter((e) => n(e) === t), ...i.filter((e) => n(e) !== t)] : i.filter((t) => o(t) === t)).filter((i) => !t || n(i) === t || (!!e && b(i) !== i));
                                            })(y, k, w),
                                            S = await d(e, E),
                                        ...
                                        const B = [S[o(L)], S[C], S[O]],
                                            ...
                                            T = _[P + 1];
                                        if (T) return { data: { index: P + 1, overflows: A }, reset: { placement: T } };
                                        const D = A.slice().sort((t, e) => t.overflows[0] - e.overflows[0]),
                                            R =
                                                null ==
                                                (l = D.find((t) => {
                                                    let { overflows: e } = t;
                        ...
                        E = function (t) {
                            return (
                                void 0 === t && (t = {}),
                                {
                                    ...
                                    async fn(e) {
                                        var i;
                                        const { placement: n, middlewareData: r, rects: s, initialPlacement: a, platform: l, elements: c } = e,
                                        ...
                                        if ((u && _.push(E[w]), f)) {
                                            const { main: t, cross: e } = v(n, s, await (null == l.isRTL ? void 0 : l.isRTL(c.floating)));
                                            _.push(E[t], E[e]);
                                        }
                                        if (((S = [...S, { placement: n, overflows: _ }]), !_.every((t) => t <= 0))) {
                                            var P, L;
                                ...
                                async fn(t) {
                                    ...
                                    switch (e) {
                                        case "referenceHidden": {
                                            const e = _(await d(t, { ...i, elementContext: "reference" }), o.reference);
                                            return { data: { referenceHiddenOffsets: e, referenceHidden: S(e) } };
                                        }
                                        case "escaped": {
                                            const e = _(await d(t, { ...i, altBoundary: !0 }), o.floating);
                        ...
                        B = function (t) {
                            return (
                                void 0 === t && (t = {}),
                                {
                                    options: t,
                                    fn(e) {
                                        const { x: i, y: n, placement: s, rects: a, middlewareData: l } = e,
                                        ...
                                        if (u) {
                                            ...
                                            const t = "y" === p ? "width" : "height",
                                                ...
                                                n = a.reference[h] + a.reference[t] + (e ? 0 : null != (x = null == (k = l.offset) ? void 0 : k[h]) ? x : 0) - (e ? y.crossAxis : 0);
                                            m < i ? (m = i) : m > n && (m = n);
                                        }
                                        return { [p]: g, [h]: m };
                                    },
                        ...
                        T = function (t) {
                            return (
                                void 0 === t && (t = {}),
                                {
                                    ...
                                    async fn(e) {
                                        var i;
                                        const { placement: n, elements: s, rects: a, platform: d, strategy: p } = e,
                                                    ...
                                                    getBoundingClientRect: function () {
                                                        ...
                                                        if (y.length >= 2) {
                                                            ...
                                                            const t = "left" === o(n),
                                                                e = f(...y.map((t) => t.right)),
                                                                i = u(...y.map((t) => t.left)),
                                                                s = y.filter((o) => (t ? o.left === i : o.right === e)),
                                                                a = s[0].top,
                    ...
                    function F(t) {
                        const { overflow: e, overflowX: i, overflowY: o, display: n } = M(t);
                        return /auto|scroll|overlay|hidden/.test(e + o + i) && !["inline", "contents"].includes(n);
                    }
                    function I(t) {
                    ...
                    function Z(t, e, i) {
                        ...
                        let l = 1,
                            c = 1;
                        e && W(t) && ((l = (t.offsetWidth > 0 && X(a.width) / t.offsetWidth) || 1), (c = (t.offsetHeight > 0 && X(a.height) / t.offsetHeight) || 1));
                        const d = z(t) ? R(t) : window,
                            u = !G() && i,
                            f = (a.left + (u && null != (o = null == (n = d.visualViewport) ? void 0 : n.offsetLeft) ? o : 0)) / l,
                    ...
                    function tt(t) {
                        return "html" === H(t) ? t : t.assignedSlot || t.parentNode || (V(t) ? t.host : null) || J(t);
                    }
                    function et(t) {
                    ...
                    function st(t, e, i) {
                        return "viewport" === e
                            ? c(
                                  (function (t, e) {
                                      ...
                                      if (n) {
                                          ...
                                          const t = G();
                                          (t || (!t && "fixed" === e)) && ((a = n.offsetLeft), (l = n.offsetTop));
                                      }
                            ...
                            ? (function (t, e) {
                                  ...
                                  return { top: o, left: n, x: n, y: o, right: n + t.clientWidth, bottom: o + t.clientHeight, width: t.clientWidth, height: t.clientHeight };
                              })(e, i)
                            : c(
                                  (function (t) {
                                      var e;
                                      const i = J(t),
                                          ...
                                          r = Y(i.scrollWidth, i.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0),
                                          s = Y(i.scrollHeight, i.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0);
                                      let a = -o.scrollLeft + K(t);
                                      const l = -o.scrollTop;
                                      return "rtl" === M(n || i).direction && (a += Y(i.clientWidth, n ? n.clientWidth : 0) - r), { width: r, height: s, x: a, y: l };
                                  })(J(t))
                              );
                    }
                    function at(t) {
                        const e = rt(t),
                            i = (function (t, e) {
                                let i = t;
                                for (; i && !q(i) && !e.includes(i) && (!z(i) || !["absolute", "fixed"].includes(M(i).position)); ) {
                                    const t = tt(i);
                                    i = V(t) ? t.host : t;
                                }
                                return i;
                    ...
                    const lt = {
                        getClippingRect: function (t) {
                            ...
                            const r = [...("clippingAncestors" === i ? at(e) : [].concat(i)), o],
                                s = r[0],
                                a = r.reduce((t, i) => {
                                    const o = st(e, i, n);
                                    return (t.top = Y(o.top, t.top)), (t.right = $(o.right, t.right)), (t.bottom = $(o.bottom, t.bottom)), (t.left = Y(o.left, t.left)), t;
                                }, st(e, s, n));
                        ...
                        convertOffsetParentRelativeRectToViewportRelativeRect: function (t) {
                            ...
                            let s = { scrollLeft: 0, scrollTop: 0 };
                            const a = { x: 0, y: 0 };
                            if ((n || (!n && "fixed" !== o)) && (("body" !== H(i) || F(r)) && (s = U(i)), W(i))) {
                                const t = Z(i, !0);
                        ...
                        getElementRects: (t) => {
                            ...
                            return { reference: Q(e, it(i), o), floating: { ...ot(i), x: 0, y: 0 } };
                        },
                    ...
                    function ct(t, e, i, o) {
                        void 0 === o && (o = {});
                        const { ancestorScroll: n = !0, ancestorResize: r = !0, elementResize: s = !0, animationFrame: a = !1 } = o,
                            l = n && !a,
                            c = l || r ? [...(z(t) ? rt(t) : []), ...rt(e)] : [];
                        c.forEach((t) => {
                        ...
                        return (
                            a &&
                                (function e() {
                                    const o = Z(t);
                                    !f || (o.x === f.x && o.y === f.y && o.width === f.width && o.height === f.height) || i(), (f = o), (d = requestAnimationFrame(e));
                                })(),
                            i(),
                            () => {
                                var t;
                    ...
                    const dt = (t, e, i) =>
                        (async (t, e, i) => {
                            const { placement: o = "bottom", strategy: n = "absolute", middleware: r = [], platform: s } = i,
                                l = await (null == s.isRTL ? void 0 : s.isRTL(e));
                            let c = await s.getElementRects({ reference: t, floating: e, strategy: n }),
                                { x: d, y: u } = a(c, o, l),
                                f = o,
                                p = {},
                                h = 0;
                            for (let i = 0; i < r.length; i++) {
                                const { name: g, fn: m } = r[i],
                                    { x: v, y, data: b, reset: w } = await m({ x: d, y: u, initialPlacement: o, placement: f, strategy: n, middlewareData: p, rects: c, platform: s, elements: { reference: t, floating: e } });
                                (d = null != v ? v : d),
                                    (u = null != y ? y : u),
                                    (p = { ...p, [g]: { ...p[g], ...b } }),
                                    w &&
                                        ...
                                        (h++,
                                        "object" == typeof w &&
                                            (w.placement && (f = w.placement), w.rects && (c = !0 === w.rects ? await s.getElementRects({ reference: t, floating: e, strategy: n }) : w.rects), ({ x: d, y: u } = a(c, f, l))),
                                        (i = -1));
                            }
                            return { x: d, y: u, placement: f, strategy: n, middlewareData: p };
                        })(t, e, { platform: lt, ...i });
                },
                131: (t, e, i) => {
                    i.p;
                    ...
                    Object.defineProperty(e, "__esModule", { value: !0 }),
                        ...
                        (e.computeBackdropPosition = function (t) {
                            return new Promise(async (e, i) => {
                                ...
                                (t.backdrop.style.pointerEvents = o.propagateEvents ? "none" : ""),
                                    (t.backdrop.style.width = (s ? r.width : r.width + t.options.targetPadding) + "px"),
                                    (t.backdrop.style.height = (r.height ? r.height + t.options.targetPadding : r.height) + "px"),
                                    e(!0);
                            });
                        });
                },
                ...
                693: (t, e, i) => {
                    ...
                    const o = i(500),
                        n = i(362);
                        async function r(t) {
                            if (t.options.dialogClass) {
                              // Ensure dialogClass is an array
                              const dialogClasses = Array.isArray(t.options.dialogClass)
                                ? t.options.dialogClass
                                : t.options.dialogClass.split(" "); // Split string into array
                          
                              dialogClasses.forEach((className) => t.dialog.classList.add(className));
                            }
                          
                            if (t.options.dialogZ) {
                        ...
                        if (
                            ((e += "<div class='card-header tg-dialog-header'>"),
                            (e += '<div class="card-title tg-dialog-title w-100" id="tg-dialog-title">\x3c!-- JS rendered --\x3e</div>'),
                            t.options.closeButton &&
                                ((e += '<div class="btn btn-sm btn-icon btn-no-txt btn-secondary rounded-circle position-absolute top-0 start-100 translate-middle" id="tg-dialog-close-btn">'),
                                (e +=
                                    ' <i class="icon b2b-Cancel-sm"></i>'),
                                (e += "</div>")),
                            ...
                            (e += "</div>"),
                            (e += "</div>"),
                            t.options.progressBar && (e += '<div class="progress mt-3 tg-dialog-progress-bar"><span class="progress-bar bg-info tg-bar" id="tg-dialog-progbar"></span></div>'),
                            (e += '<div class="card-body pt-3 tg-dialog-body" id="tg-dialog-body">\x3c!-- JS rendered --\x3e</div>'),
                            t.options.showStepDots && "body" === t.options.stepDotsPlacement)
                        ) {
                            const t = (0, o.dotsWrapperHtmlString)();
                            t && (e += t);
                        }
                        e += '<div class="card-footer p-0 pt-3 tg-dialog-footer">';
                        let i = "btn",
                            n = "false";
                        if (
                            (0 === t.activeStep && ((n = "true"), (i += " disabled")),
                            t.options.showButtons && !t.options.hidePrev && (e += '<button type="button" class=" ' + i + '" id="tg-dialog-prev-btn" disabled="' + n + `">${t.options.prevLabel}</button>`),
                        ...
                        return (
                            ...
                            (e += "</div>"),
                            t.options.showButtons && !t.options.hideNext && (e += `<button type="button" class="btn btn-primary" id="tg-dialog-next-btn">${t.options.nextLabel}</button>`),
                            (e += "</div>"),
                    ...
                    (e.createTourGuideDialog = async function () {
                        ...
                        (e.updateDialogHtml = function (t) {
                            return new Promise((e, i) => {
                                ...
                                s && n && ("string" == typeof n.content ? (s.innerHTML = n.content ? n.content : "") : ((s.innerHTML = ""), s.append(n.content)));
                                const a = document.getElementById("tg-dialog-dots");
                                a && t.options.showStepDots && (0, o.computeDots)(t) && (a.innerHTML = (0, o.computeDots)(t));
                                const l = document.getElementById("tg-dialog-prev-btn");
                                l && (0 === t.activeStep ? (l.classList.add("btn", "btn-outline-secondary"), l.setAttribute("disabled", "true")) : (l.classList.remove("disabled"), l.removeAttribute("disabled")));
                        ...
                        (e.computeDialogPosition = function (t) {
                            return new Promise(async (e) => {
                                ...
                                let o = t.tourSteps[t.activeStep].dialogTarget || t.tourSteps[t.activeStep].target;
                                if (o === document.body)
                                    return (
                                ...
                                (t.dialog.style.position = "absolute"),
                                    ...
                                    (0, n.computePosition)(o, t.dialog, {
                                        ...
                                        middleware: [(0, n.autoPlacement)({ autoAlignment: !0, padding: 5 }), (0, n.shift)({ crossAxis: t.options.allowDialogOverlap, padding: 15 }), (0, n.arrow)({ element: i }), (0, n.offset)(20)],
                                    }).then(
                                        ({ x: o, y: n, placement: r, middlewareData: s }) => (
                                            Object.assign(t.dialog.style, { left: `${o}px`, top: `${n}px` }),
                                            s.arrow &&
                                                i &&
                                                Object.assign(
                                                    i.style,
                                                    (function (t, e, i) {
                                                        const o = t?.x || 0,
                                                            n = t?.y || 0,
                                                            r = 10,
                                                            s = { top: "bottom", right: "left", bottom: "top", left: "right" }[e.split("-")[0]],
                                                            a = i.clientWidth - r,
                                                            l = i.clientHeight - r,
                                                            c = Math.abs(n - l) <= r,
                                                            d = Math.abs(o - a) <= r,
                                                            u = Math.abs(n) <= r,
                                                            f = Math.abs(o) <= r,
                                                            p = 0 !== t?.centerOffset || ((f || d) && (u || c));
                                                        return {
                                                            left: f ? ("right" === s ? "" : "0") : d ? `${a}px` : `${o}px`,
                                                            top: u ? ("bottom" === s ? "" : "0") : c ? `${l}px` : `${n}px`,
                                                            [s]: p ? "0" : "-5px",
                            ...
                            return (
                                t.tourSteps.length &&
                                    t.tourSteps.forEach((i, o) => {
                                        ...
                                        n.classList.add("tg-dot"), o === t.activeStep && n.classList.add("tg-dot-active"), (e += n.outerHTML);
                                    }),
                                e
                            );
                        });
                        ...
                        (e.handleInitListeners = function () {
                            ...
                            return new Promise(
                                (r) => (
                                    ...
                                    (this.options.keyboardControls || this.options.exitOnEscape) && n(),
                                    r(!0)
                                )
                            );
                        }),
                    ...
                    e.default = function () {
                        return new Promise(async (t) => {
                            (this.backdrop.style.display = "block"),
                                ...
                                window.onresize ||
                                    (window.onresize = () => {
                                        (0, o.computeBackdropPosition)(this), (0, n.computeDialogPosition)(this);
                                    }),
                                window.onscroll ||
                                    (window.onscroll = () => {
                                ...
                                t.options.steps &&
                                    ...
                                    (o = t.options.steps.map((e) => {
                                        if ("string" == typeof e.target) {
                                            ...
                                            i &&
                                                ((e.target = i),
                                                t.options.targetPadding && t.options.autoScrollOffset ? (i.style.scrollMargin = t.options.autoScrollOffset + t.options.targetPadding + "px 0") : (i.style.scrollMargin = "30px 0"));
                                        }
                                        if ((e.target || (e.target = document.body), "string" == typeof e.dialogTarget)) {
                    ...
                    Object.defineProperty(e, "__esModule", { value: !0 }),
                        (e.default = async function () {
                            return new Promise(async (t, e) => {
                                ...
                                if (((this._promiseWaiting = !0), this._globalBeforeExitCallback))
                                    try {
                ...
                283: (t, e) => {
                    Object.defineProperty(e, "__esModule", { value: !0 }),
                        ...
                        (e.getIsFinished = function (t = "tour") {
                            return !!localStorage.tg_tours_complete && localStorage.tg_tours_complete.split(",").includes(t);
                        }),
                        ...
                        (e.default = async function (t = !0, e = "tour") {
                            ...
                            if (this.options.completeOnFinish) {
                                ...
                                i.includes(e) || (i.push(e), (localStorage.tg_tours_complete = i));
                            }
                            return t && (await this.exit()), (this.activeStep = 0), (this._promiseWaiting = !1), !0;
                        });
                },
                612: function (t, e, i) {
                    var o =
                    ...
                    (e.handleRefreshDialog = async function () {
                        ...
                        (e.default = async function () {
                            return new Promise(async (t, e) => (await (0, n.default)(this).catch((t) => e(t)), this.computeBackdropAttributes(), await this.refreshDialog().catch((t) => e(t)), t(!0)));
                        });
                },
                340: function (t, e, i) {
                    var o =
                ...
                330: function (t, e, i) {
                    ...
                    e.default = async function (t) {
                        return new Promise(async (e, i) => {
                            ...
                            return (
                                await o.visitStep(this.activeStep).catch((t) => (this.options.debug && console.warn(t), i(t))),
                ...
                483: function (t, e, i) {
                    ...
                    function s(t, e) {
                        return new Promise(async (i, o) => {
                            ...
                            if ((((t._globalBeforeChangeCallback && e !== s) || a.beforeLeave || l.beforeEnter) && ((t._promiseWaiting = !0), t.dialog.classList.add("tg-dialog-loading")), t._globalBeforeChangeCallback && e !== s))
                                try {
                        ...
                        (e.default = async function (t) {
                            return new Promise(async (e, i) =>
                                this._promiseWaiting
                                    ? i("Promise waiting")
                                    : ("string" == typeof t && (t = "next" === t ? this.activeStep + 1 : this.activeStep - 1),
                                      t >= this.tourSteps.length ? void (await this.finishTour(!0, this.group)) : (await s(this, t).catch((t) => i(t)), e(!0)))
                            );
                        });
                },
                717: (t, e) => {
